...
export default function DashboardStats() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const revenue = (revenueRows || []).reduce((sum, o) => sum + Number(o.total_amount || 0), 0);
  ...
  const cards = [
    ...
    { label: 'Awaiting Action', value: stats.pendingCount + stats.confirmedCount + stats.outCount, link: '/admin/orders' },
    { label: 'Products', value: stats.productCount, link: '/admin/products' },
    { label: 'Delivered Revenue', value: `৳${stats.revenue.toLocaleString()}`, link: '/admin/orders' },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h2 className="text-sm font-semibold text-slate-900 mb-4">Order Pipeline</h2>
