    ...
    <>
      {showWhatsapp && (
        <a
          ...
          className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center hover:scale-105 transition-transform"
        >
      ...
      {showMessenger && (
        <a
          ...
          className="fixed bottom-5 left-5 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF] shadow-lg flex items-center justify-center hover:scale-105 transition-transform"
        >
          <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
